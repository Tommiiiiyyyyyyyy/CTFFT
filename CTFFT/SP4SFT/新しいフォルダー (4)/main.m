...
[ N, c, flatwin_c, d_c, l, k, B, prm_mat, filename_prm ] = define_param( );%シミュレーションにおいて設計するパラメータの関数。
...
filename = [datestr(now, 'yyyymmdd_HHMMSS'),'_results.mat'];%ファイル名にシミュレーション時刻を加える。
...
s = struct(field1,value1,field2,value2,field3,value3,field4,value4,field5,value5,field6,value6,field7,value7,field8,value8,field9,value9,field10,value10,field11,value11,field12,value12,field13,value13);
cd(SR);
